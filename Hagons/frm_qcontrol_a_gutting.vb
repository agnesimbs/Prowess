...
Public Class frm_qcontrol_a_gutting
    ...
    Private Sub frm_qcontrol_a_processing_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            mic_functs.create_button_controls(dg_q_control, actions, n, "Enter QC")
